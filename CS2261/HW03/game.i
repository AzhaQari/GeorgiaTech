...
void initAsteroid() {
 ...
 asteroids[0].color = ((31) | (31)<<5 | (0)<<10);
 asteroids[1].color = ((31) | (0)<<5 | (0)<<10);
}
...
void drawAsteroid(ASTEROID* a) {
 if(a->active) {
  drawRect(a->oldCol, a->oldRow, a->width + 50, a->height, 0);
  drawRect(a->col, a->row, a->width, a->height, a->color);
 } else if (!a->erased) {
  drawRect(a->oldCol, a->oldRow, a->width, a->height, 0);
  a->erased = 1;
 } else if (!a->active) {
  drawRect(a->oldCol, a->oldRow, a->width, a->height, 0);
 }
