/*
How to play: I changed the game to be survival based for simplicity. Just dodge the coronavirus troop for as long as possible using up/left/right buttons

finished: collision map, collision detection for killing player, player jumping/gravity, music and sfx, background screens
