...
void goToGame() {
    ...
    (*(volatile unsigned short*)0x4000008) = (0<<14) | ((0)<<2) | ((28)<<8);
    DMANow(3, backgroundTiles, &((charblock *)0x6000000)[0], 3776/2);
...
void goToInstructions() {
    ...
    DMANow(3, instructionsScreenTiles, &((charblock *)0x6000000)[0], 4032/2);
    DMANow(3, instructionsScreenMap, &((screenblock *)0x6000000)[29], 2048/2);
...
void goToPause() {
    ...
    DMANow(3, pauseScreenTiles, &((charblock *)0x6000000)[0], 12576/2);
...
void goToLose() {
    ...
    DMANow(3, loseScreenTiles, &((charblock *)0x6000000)[0], 4160/2);
