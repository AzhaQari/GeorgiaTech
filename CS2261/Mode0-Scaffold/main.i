...
# 1 "loseScreen.h" 1
# 22 "loseScreen.h"
extern const unsigned short loseScreenTiles[960];
...
void initialize()
{
    ...
    DMANow(3, froggerPal, ((unsigned short *)0x5000200), 512 / 2);
    DMANow(3, froggerTiles, &((charblock *)0x6000000)[4], 512);
    for (int i = 0; i < 128; i++) {
...
void goToStart() {
    ...
    DMANow(3, screenStatesPal, ((unsigned short *)0x5000000), 256);
    (*(volatile unsigned short *)0x4000008) = (0 << 14) | ((0) << 2) | ((28) << 8);
    DMANow(3, screenStatesTiles, &((charblock *)0x6000000)[0], 7808 / 2);
    DMANow(3, screenStatesMap, &((screenblock *)0x6000000)[28], 2048 / 2);
    state = START;
...
void goToPause() {
    ...
    DMANow(3, pauseScreenTiles, &((charblock *)0x6000000)[0], 928/2);
...
void goToLose() {
    ...
    DMANow(3, loseScreenTiles, &((charblock *)0x6000000)[0], 1920/2);
