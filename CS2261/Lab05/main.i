...
void goToStart() {
    ...
    drawString(99, 96, "CS 2261", ((15) | (15)<<5 | (15)<<10));
    state = START;
...
void goToGame() {
    ...
    drawString(5, 145, "Ball Count: ", ((0) | (31)<<5 | (31)<<10));
...
void game() {
    ...
    drawString(76, 145, buffer, ((22) | (6)<<5 | (13)<<10));
...
void goToPause() {
    ...
    drawString(12, 12, "PAUSE", ((15) | (15)<<5 | (15)<<10));
    state = PAUSE;
}
...
void goToWin() {
    ...
    drawString(12, 12, "WIN", ((0) | (31)<<5 | (0)<<10));
...
void goToLose() {
    ...
    drawString(12, 12, "LOSE", ((31) | (0)<<5 | (0)<<10));
