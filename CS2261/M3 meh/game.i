...
void updateGame() {
    if ((~((*(volatile unsigned short *)0x04000130)) & ((1 << 5)))) hoff -= 3;
    if ((~((*(volatile unsigned short *)0x04000130)) & ((1 << 4)))) hoff += 3;
...
void updatePlayer() {
 ...
 if ((~((*(volatile unsigned short *)0x04000130)) & ((1 << 5)))
  ...
  player.col += player.cdel;
    ...
    if (((player.row + player.rdel) >> 8) < 144) {
    ...
    if ((!(~(oldButtons) & ((1 << 6))) && (~buttons & ((1 << 6)))) && !jumped) {
        player.rdel -= 1500;
        jumped = 1;
    }
    player.rdel += 75;
...
void updateRona() {
    ...
    if (!(~((*(volatile unsigned short *)0x04000130)) & ((1 << 7))) && collision(rona.col, rona.row, rona.width, rona.height, player.col, ((player.row) >> 8), player.width, player.height)) {
        health -= 3;
    }
}

void drawRona() {
    shadowOAM[1].attr0 = (0 << 14) | (0xFF & rona.row);
 shadowOAM[1].attr1 = (0 << 14) | (0x1FF & rona.col);
