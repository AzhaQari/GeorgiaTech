...
# 1 "winScreen.h" 1
# 22 "winScreen.h"
extern const unsigned short winScreenTiles[5456];
...
enum {BLACKID=(256-6), GREENID, PERSIANID, REDID, WHITEID, GRAYID};
...
# 1 "courseFull.h" 1
# 22 "courseFull.h"
extern const unsigned short courseFullTiles[864];


extern const unsigned short courseFullMap[14336];


extern const unsigned short courseFullPal[256];
# 13 "main.c" 2
...
void initialize()
{
    ...
    DMANow(3, playerPal, ((unsigned short *)0x5000200), 256);
...
void goToStart() {
    ...
    DMANow(3, splashScreenTiles, &((charblock *)0x6000000)[0], 3424/2);
    DMANow(3, splashScreenMap, &((screenblock *)0x6000000)[8], 2048/2);
    state = START;
}
...
void goToGame() {
    DMANow(3, courseFullPal, ((unsigned short *)0x5000000), 256);
    (*(volatile unsigned short *)0x4000008) = (1 << 14) | ((0) << 2) | ((sbb) << 8);
    DMANow(3, courseFullTiles, &((charblock *)0x6000000)[0], 1728/2);
    DMANow(3, courseFullMap, &((screenblock *)0x6000000)[sbb], 28672/2);
    state = GAME;
}
...
void goToInstructions() {
    ...
    DMANow(3, instructionsScreenTiles, &((charblock *)0x6000000)[0], 2496/2);
    DMANow(3, instructionsScreenMap, &((screenblock *)0x6000000)[8], 2048/2);
...
void goToPause() {
    ...
    DMANow(3, pauseScreenTiles, &((charblock *)0x6000000)[0], 1888/2);
    DMANow(3, pauseScreenMap, &((screenblock *)0x6000000)[8], 2048/2);
...
void goToWin() {
    ...
    DMANow(3, winScreenTiles, &((charblock *)0x6000000)[0], 10912/2);
    DMANow(3, winScreenMap, &((screenblock *)0x6000000)[8], 2048/2);
...
void goToLose() {
    ...
    DMANow(3, loseScreenTiles, &((charblock *)0x6000000)[0], 1408/2);
    DMANow(3, loseScreenMap, &((screenblock *)0x6000000)[8], 2048/2);
