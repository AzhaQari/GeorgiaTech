...
# 1 "heart.h" 1
# 21 "heart.h"
extern const unsigned short heartBitmap[128];
...
# 1 "bird.h" 1
# 21 "bird.h"
extern const unsigned short birdBitmap[128];
...
# 1 "predator.h" 1
# 21 "predator.h"
extern const unsigned short predatorBitmap[128];


extern const unsigned short predatorPal[256];
# 7 "game.c" 2
...
void initGame() {
 ...
 health = 20;
    ...
    unsigned short colors[6] = {0, ((0) | (31)<<5 | (0)<<10), ((0) | (21)<<5 | (20)<<10), ((31) | (0)<<5 | (0)<<10), ((31) | (31)<<5 | (31)<<10), ((15) | (15)<<5 | (15)<<10)};


    dma[3].cnt = 0;
    dma[3].src = heartPal;
    dma[3].dst = ((unsigned short *)0x5000000);
    dma[3].cnt = 1 << 31 | 256;

    dma[3].cnt = 0;
    dma[3].src = birdPal + 16;
    dma[3].dst = ((unsigned short *)0x5000000) + 16;
    dma[3].cnt = 1 << 31 | 16;

    dma[3].cnt = 0;
    dma[3].src = predatorPal + 32;
    dma[3].dst = ((unsigned short *)0x5000000) + 32;
    dma[3].cnt = 1 << 31 | 16;
...
void updatePlayer() {
 ...
 if ((~((*(volatile unsigned short *)0x04000130)) & ((1<<5)))
  ...
  && player.row + player.height < 160 - 2) {
