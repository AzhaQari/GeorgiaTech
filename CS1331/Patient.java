//I worked on this assignment alone, using only course materials and office hours
...
public class Patient implements Comparable<Patient> {
    ...
    /*
    public void increaseHealth(HealAbility ha) {
        this.health += ha.getHealAmount();
    }
    */
    @Override
    ...
    /**
    * Method to increase the health.
    * @param ha is a passed in HealAbility object.
    */
    public void increaseHealth(HealAbility ha) {
        this.health += ha.getHealAmount();
        System.out.println("Patient " + this.name + " has been healed by " + ha.getHealAmount() + " health points!");
    }
