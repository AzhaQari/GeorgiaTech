public class Converter {
    ...
    public static double fahrenheitToCelsius(int temp) {
        double fahrenheitToCelsius = (temp - 32) * (5.0 / 9.0);
    ...
    public static double celsiusToFahrenheit(int temp) {
        double celsiusToFahrenheit = (temp * (9.0 / 5.0)) + 32;
    ...
    public static void printFahrenheitConversionTable(int lower, int upper) {
        for (int num = lower; lower <= upper; lower++) {
            double fahrenheitToCelsius = (lower - 32) * (5.0 / 9.0);
            System.out.printf("Fahrenheit: %d -> Celsius: %2.3f\n", lower, fahrenheitToCelsius);
        }
    }
    ...
    public static void printCelsiusConversionTable(int lower, int upper) {
        int count = lower;
        while (count <= upper) {
            double celsiusToFahrenheit = (count * (9.0 / 5.0)) + 32;
            System.out.printf("Celsius: %d -> Fahrenheit: %2.3f\n", count, celsiusToFahrenheit);
            lower++;
            count++;
        }
    }
    ...
    public static boolean celsiusWarmer(int celsius, int fahrenheit) {
        ...
        /*if (celsiusToFahrenheit > fahrenheit) {
            return true;
        } else {
            return false;
        }
    ...
    public static boolean fahrenheitWarmer(int fahrenheit, int celsius) {
        double celsiusToFahrenheit = (celsius * (9.0 / 5.0)) + 32;
        boolean returnBool = (fahrenheit > celsiusToFahrenheit) ? true : false;
        return returnBool;
