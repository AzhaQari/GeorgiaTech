public class Board {
    ...
    public boolean isValid(Location b) {
        if (b.getRow() < 3 && b.getRow() >= 0 && b.getColumn() < 3 && b.getColumn() >= 0) {
            return (board[b.getRow()][b.getColumn()] == ' ');
        } else {
            return false;
        }
    }

    public boolean isSuccessful(Location a, char letter) {
        if (this.isValid(a)) {
            board[a.getRow()][a.getColumn()] = letter;
            return true;
        } else {
            return false;
        }
